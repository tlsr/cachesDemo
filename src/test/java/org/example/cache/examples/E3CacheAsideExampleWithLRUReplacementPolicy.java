...
@SpringBootTest
class E3CacheAsideExampleWithLRUReplacementPolicy {
    ...
    /*
     * This example shows LRU(Least Recently used) replacement policy
     *
     * */
    @Test
    @DisplayName("LRU example")
    void test1() {
        aspectsLoggersConfig.disableAll();
        ...
        PrintUtils.print("This email : " + firstKey + " was fetched first so it is least recently used");
        ...
        PrintUtils.print("Reading: " + firstKey + " directly from cache");
        Optional<Customer> leastRecentlyOpt = cache.get(firstKey);
